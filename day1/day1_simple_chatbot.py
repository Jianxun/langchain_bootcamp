...
def main():
    print("Welcome to the Advanced LangChain Chatbot!")
    ...
    while True:
        ...
        try:
            ...
            print(f"\nError: {str(e)}")
            print("Please make sure your OpenAI API key is set correctly in the .env file.")
